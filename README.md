...
| backgroundImageCors  |        String         |                    | Set the crossorigin attribute of the background image. Accepted values: `"anonymous"`, `"user-credentials"`. Refer to [this site](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img#attributes) for more information.                                           |
